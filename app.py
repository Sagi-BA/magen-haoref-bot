...
the boty link: https://magen-haoref-bot.streamlit.app/
need to add it to: http://crm.resiliencecenter.org.il/login
"""
...
def render_sidebar():
    ...
    with st.sidebar:
        ...
        st.markdown(
            """
- **ער"ן:** [*2201](tel:*2201) / [*3201](tel:*3201)
- **נפש אחת:** [*8944](tel:*8944)
- **סה"ר:** [055-957-1399](tel:0559571399) | [sahar.org.il](https://sahar.org.il)
"""
        )
        st.divider()
        ...
        st.markdown(
            """
- **מוקד מילואים:** [1111](tel:1111) שלוחה 4
- **נטאלי סילבר:** [055-941-0030](tel:0559410030)
- **שגיא בר און:** [054-999-5050](tel:0549995050)
- **שלומי אזולאי:** [052-395-4499](tel:0523954499)
- **אורנה אביקזר:** [052-555-5658](tel:0525555658)
- **נמרוד אסא:** [052-642-6787](tel:0526426787)
- **לילך אביסרור:** [054-774-3672](tel:0547743672)
"""
        )
        st.divider()
        ...
        st.markdown(
            """
- **עו"ד מוריאל קוט:** [053-354-5552](tel:0533545552)
- **רו"ח יקי קינן:** [054-779-6571](tel:0547796571)
- **רו"ח כוכב אבשלום:** [053-966-6740](tel:0539666740)
"""
        )
        st.divider()
